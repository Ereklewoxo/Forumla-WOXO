...
namespace Formula_WOXO
{
    public static class Graphics
    {
        ...
        {
            string headerName = WriteHeader(Database.GrandsPrix[selected].Name);
        ...
        public static void DrawCircuitMap(int x, int y, int selected, string color)
        {
            ...
            WriteAt(x + adjustX, y + (5 - adjustY), FromHex(color) + circuit);
        }
        ...
        public static void DrawInitialF1Logo()
        {
            ...
            DrawF1Logo(2, x, y - 10, true);
            ClearKey();
            while (true)
            {
                Console.Write(FromRgb(i, 12, 12));
                DrawF1Logo(0, x, y, false);
                i = pulse ? Math.Min(225, i + 2) : Math.Max(12, i - 2);
                pulse = i is 225 || i is 12 ? !pulse : pulse;
            ...
            for (int j = 0; j < 4;)
            {
                Console.Write(FromRgb(i, 12, 12));
                DrawF1Logo(0, x, y, false);
                i = pulse ? Math.Min(225, i + 20) : Math.Max(12, i - 20);
                pulse = i is 225 || i is 12 ? !pulse : pulse;
                if (i > 224 || i < 13)
                    j++;
                if (Console.WindowWidth + Console.WindowHeight != windowSize)
            ...
            DrawF1Logo(2, x, y - 10, false);
            ClearKey();
        }
        public static void DrawF1Logo(int logoIndex, int x, int y, bool animation)
        {
            if (logoIndex is 0)
            {
                if (animation)
            ...
            else if (logoIndex is 2)
            {
                ...
                if (animation)
                {
                    ...
                    {
                        Console.Write(FromRgb(12 + i * 10, 12, 12));
